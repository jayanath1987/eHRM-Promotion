...
<div class="formpage4col">
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Edit Promotion Method") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <br class="clear"/>
            <div class="leftCol">
                <label  for="txtLocationCode"><?php echo __("Promotion Method") ?> <span class="required">*</span></label>
            </div>
            <div class="centerCol">
                <textarea id="txtName"  name="txtName" type="text"  class="formTextArea" value="" ><?php echo $PromotionMethod->getPrm_method_comment_en() ?></textarea>
            </div>



            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea"  name="txtNamesi" type="text"><?php echo $PromotionMethod->getPrm_method_comment_si() ?></textarea>

            </div>

            <div class="centerCol">
                <textarea id="txtJobTitleComments" class="formTextArea"  name="txtNameta" type="text"><?php echo $PromotionMethod->getPrm_method_comment_ta() ?></textarea>
...
<?php } ?>
        ...
        $("#editBtn").click(function() {
            ...
            if (editMode == 1) {
                ...
                location.href="<?php echo url_for('promotion/updatePromotionMethod?id=' . $PromotionMethod->getPrm_method_id() . '&lock=1') ?>";
            }
            else {
        ...
        $("#btnClear").click(function() {
            ...
            location.href="<?php echo url_for('promotion/updatePromotionMethod?id=' . $PromotionMethod->getPrm_method_id() . '&lock=0') ?>";
        });
