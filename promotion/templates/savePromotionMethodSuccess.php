...
<div class="formpage4col">
    ...
    <div id="status"></div>
    <div class="outerbox">
        <div class="mainHeading"><h2><?php echo __("Add Promotion Method") ?></h2></div>
        <form name="frmSave" id="frmSave" method="post"  action="">
            ...
            <div class="centerCol">
                <textarea id="txtName"  name="txtName"   class="formTextArea" rows="3" cols="5"  ></textarea>
            </div>



            <div class="centerCol">
                <textarea id="txtJobTitleDesc" class="formTextArea"  rows="3" cols="5" name="txtNamesi"></textarea>

            </div>

            <div class="centerCol">
                <textarea id="txtJobTitleComments" class="formTextArea" rows="3" cols="5" name="txtNameta"></textarea>
